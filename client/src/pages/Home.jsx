...
const RenderCards = ({data,title})=>{
  if(data?.lenggth > 0 ) return data.map((post)=><Card key={post.id} {...post}/>)
  return(
  ...
  return (
    <section className='max-w-7xl mx-auto'>
      <div>
        ...
        <p className='mt-2 text-[#666e75] text-[16px] max-w-[500px]'>Browser through a collection of imaginative and visually stunning images that generated by DALL-E AI</p>
      </div>
      <div className='mt-16'>
        <FormField/>
      </div>
