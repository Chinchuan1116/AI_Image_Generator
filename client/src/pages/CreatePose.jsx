...
import { getRandomPrompt } from '../utlis'
    ...
    <section className='max-w-7xl mx-auto'>
      ...
      <form className='mt-16 max-w-3xl' onSubmit={handleSubmit()}>
        <div className='flex flex-col gap-5'>
          ...
          <div className='relative bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 w-64 h-64 flex justify-center items-center p-3 w-64'>
            {form.photo ? (
            ...
            {generatingImg && (
              <div className='absolute inset-0 z-0 flex justify-center items-start bg-[rgba(0,0,0,0.5) rounded-lg]'>
                <Loader/>
              </div>
            )}
          </div>
        ...
        <div className='mt-5 flex gap-5'>
          <button type='button' onClick={generatingImage} className='text-white bg-green-700 rounded-md text-sm w-full sm:w-auto px-5 py-2.5 text-center font-medium'>{generatingImg ? 'Generating...':'Generate'}</button>
        </div>
        <div className='mt-10'>
